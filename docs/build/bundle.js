...
`;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "sandbox-wrapper svelte-1iwow4r");
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "--deg1", getDegRng(-5, 5) + "deg");
    			set_style(div0, "--deg2", getDegRng(-5, 5) + "deg");
    			set_style(div0, "--deg3", getDegRng(-5, 5) + "deg");
    			add_location(div0, file$6, 19, 1, 507);
    			attr_dev(div1, "class", "wrapper svelte-w31xxv");
    			add_location(div1, file$6, 26, 1, 703);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(tabpanel0, div1, null);
    			append_dev(div1, t1);
    			mount_component(tabpanel1, div1, null);
    			append_dev(div1, t2);
    			mount_component(tabpanel2, div1, null);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(article_1, "class", "svelte-cgveqt");
    			add_location(article_1, file$8, 11, 0, 198);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	let if_block_anchor;
    	let if_block = /*article*/ ctx[0] && create_if_block$2(ctx);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(1, container.innerHTML = article, container);
    	});
    	...
    	$$self.$capture_state = () => ({ onMount, article, container });
    	...
    	return [article, container, article_1_binding];
    }

    class SideArticle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { article: 0 });
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "filler svelte-9p2thi");
    			add_location(section, file$9, 53, 4, 1358);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-9p2thi");
    			add_location(section, file$9, 49, 4, 1267);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(sidearticle, section, null);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			section = element("section");
    			attr_dev(section, "class", "filler svelte-9p2thi");
    			add_location(section, file$9, 60, 4, 1605);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    		},
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "code svelte-9p2thi");
    			add_location(section, file$9, 56, 4, 1428);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(section, "focusin", /*activate*/ ctx[7], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(article_1, "class", "svelte-9p2thi");
    			add_location(article_1, file$9, 47, 0, 1192);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, article_1, anchor);
    			if_blocks[current_block_type_index].m(article_1, null);
    			append_dev(article_1, t);
    			if_blocks_1[current_block_type_index_1].m(article_1, null);
    ...
    function create_if_block$4(ctx) {
    	...
    	let if_block = /*selectedDay*/ ctx[1].slides && create_if_block_1$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-3aoh4k");
    			add_location(h1, file$b, 70, 2, 1821);
    			attr_dev(p, "class", "svelte-3aoh4k");
    			add_location(p, file$b, 71, 2, 1853);
    			attr_dev(nav, "class", "svelte-3aoh4k");
    			add_location(nav, file$b, 72, 2, 1886);
    			attr_dev(header, "class", "svelte-3aoh4k");
    			add_location(header, file$b, 69, 1, 1809);
    			attr_dev(main, "class", "svelte-3aoh4k");
    			add_location(main, file$b, 78, 1, 2055);
    			attr_dev(span, "class", "svelte-3aoh4k");
    			add_location(span, file$b, 88, 2, 2422);
    			attr_dev(footer, "class", "svelte-3aoh4k");
    			add_location(footer, file$b, 87, 1, 2410);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "svelte-3aoh4k");
    			toggle_class(button, "selected", /*day*/ ctx[14] === /*selectedDay*/ ctx[1]);
    			add_location(button, file$b, 74, 4, 1921);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$b(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*selectedDay*/ ctx[1] && create_if_block$4(ctx);
